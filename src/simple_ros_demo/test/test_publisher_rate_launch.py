...
"""
ROS2 launch_testing 集成测试：验证 Publisher 发布频率
...
class _RateProbe(Node):
    """
    频率探测节点：订阅 /cmd_vel 并记录每条消息的接收时间戳
...
class TestPublisherRate(unittest.TestCase):
    """
    主测试类：验证 Publisher 发布频率是否符合 10Hz ± 2Hz
